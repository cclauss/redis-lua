...
context("Client features", function()
    ...
    test("Return error replies in their pipeline slots", function()
        ...
        assert_equal(replies[1], 'value')
        assert_type(replies[2], 'table')
        assert_not_nil(replies[2].error:match('WRONGTYPE'))
        assert_equal(replies[3], 'pipeline-tail')
...
context("Redis commands", function()
    ...
    context("Transactions", function()
        ...
        test("Return error replies in their transaction slots", function()
            client:set('wrongtype', 'value')

            local replies, count = client:transaction(function(t)
                t:get('wrongtype')
            ...
            assert_type(replies[2], 'table')
            assert_not_nil(replies[2].error:match('WRONGTYPE'))
            assert_equal(replies[3], 'transaction-tail')
